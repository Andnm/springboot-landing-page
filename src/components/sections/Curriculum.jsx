      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl font-bold mb-6 relative inline-block">
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
              Lộ trình học {totalWeeks} tuần cho khoá học chính Spring Boot
            </span>
            <div className="absolute -right-32 -top-1 transform translate-x-full">
              <div className="bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xs px-3 py-1 rounded-full shadow-md flex items-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Chương trình học được thiết kế theo trình tự từ cơ bản đến nâng cao,
            giúp bạn tiến bộ từng bước một cách vững chắc
          </p>
        </motion.div>
          ...
          >
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 shadow-sm border border-blue-100 relative overflow-hidden group hover:shadow-md transition-all duration-300">
              ...
              <p className="text-gray-600 relative z-10">
                Giáo trình được biên soạn bởi Senior với nhiều năm kinh nghiệm,
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 shadow-sm border border-green-100 relative overflow-hidden group hover:shadow-md transition-all duration-300">
              ...
              <p className="text-gray-600 relative z-10">
                Không chỉ lý thuyết, bạn sẽ được thực hành thông qua các dự án
                thực tế và xây dựng portfolio chuyên nghiệp.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 shadow-sm border border-purple-100 relative overflow-hidden group hover:shadow-md transition-all duration-300">
              ...
              <p className="text-gray-600 relative z-10">
                Hỗ trợ cải thiện CV, phỏng vấn giả lập và kết nối với các cơ hội
        ...
        >
          <div className="flex flex-col lg:flex-row gap-8">
            <div
              id="curriculum-tabs"
              className="w-full lg:w-1/3 overflow-hidden lg:overflow-y-auto lg:max-h-[850px] lg:pr-4 bg-gray-50 p-6 rounded-xl shadow-md border border-gray-100"
            >
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Sau khi hoàn thành khóa học, bạn sẽ tự tin xây dựng ứng dụng Spring
            Boot hoàn chỉnh và sẵn sàng cho vị trí Java Backend Developer tại
            các công ty phần mềm hàng đầu.
          </p>
        </motion.div>
      </div>
    </section>
